(() => {
  ...
  app.innerHTML = `
    ...
    <aside class="mh-panel" dir="rtl" aria-hidden="true">
      ...
      <section class="mh-account"><article><span>الوضع</span><strong class="mh-mode">—</strong></article><article><span>تم الفحص</span><strong class="mh-scanned">—</strong></article><article><span>آخر تحديث</span><strong class="mh-time">—</strong></article></section>
  ...
  let timer = null, countdownTimer = null, nextRefresh = 0, latest = [];
